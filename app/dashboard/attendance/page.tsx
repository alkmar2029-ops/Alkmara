  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3 flex-wrap items-center">
        <input type="date" value={date} onChange={e => { setDate(e.target.value); setPage(1); }} className="input max-w-[180px]" />
      ...
      <div className="card p-0 overflow-hidden">
        {isLoading ? <SkeletonTable /> : isError ? (
          <div className="text-center py-12 text-red-500">حدث خطأ في تحميل البيانات. حاول تحديث الصفحة.</div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {(data.data).map((r: any) => {
                  const st = STATUS_MAP[r.status] || { label: r.status, color: 'bg-gray-100' };
                  return (
